...
(function (Brauhaus) {
    ...
    var Fermentable = (function (_super) {
        ...
        Fermentable.prototype.type = function () {
            return this.nameRegexPickerArray([
                { regex: Brauhaus.Fermentable.BOIL, value: 'extract' },
                { regex: /.*/, value: 'grain' }
            ]);
        };
    ...
    Brauhaus.Fermentable = Fermentable;
})(Brauhaus || (Brauhaus = {}));
