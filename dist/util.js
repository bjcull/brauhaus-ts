...
(function (Brauhaus) {
    var Utils = (function () {
        ...
        Utils.srmToName = function (srm) {
            var color = Brauhaus.Globals.COLOR_NAMES[0].name;
            for (var i = 0; i < Brauhaus.Globals.COLOR_NAMES.length; i++) {
                if (Brauhaus.Globals.COLOR_NAMES[i].color <= srm) {
                    color = Brauhaus.Globals.COLOR_NAMES[i].name;
                }
            }
            return color;
        };
        ...
        Utils.timeToHeat = function (liters, degrees) {
            ...
            return (kj / Brauhaus.Globals.BURNER_ENERGY) * 60;
        };
        return Utils;
    })();
    Brauhaus.Utils = Utils;
})(Brauhaus || (Brauhaus = {}));
